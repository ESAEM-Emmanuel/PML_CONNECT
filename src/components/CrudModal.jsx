...
//   onClose,
//   title,
//   fields, // Utilisé pour 'create' et 'edit'
//   viewFields, // ✨ Nouvelle prop pour le mode 'view'
//   initialData = {},
//   onSubmit,
...
//               <label key={name} className="form-control mb-2">
//                 <span className="label-text">{label}</span>
//                 {type === 'select' ? (
//                   <select {...register(name, { required })} className="select select-bordered">
//                     {options.map((opt) => (
...
//         {/* Bouton de fermeture pour le mode 'view' */}
//         {isView && (
//           <div className="modal-action">
...
// import { useForm } from 'react-hook-form';
// import { X } from 'lucide-react';
// import AutocompleteInput from './AutocompleteInput'; // ✨ Importez le composant

// export default function CrudModal({
//   isOpen,
//   onClose,
//   title,
//   fields, // [{ name, label, type, required, options?, autocompleteProps? }]
//   viewFields,
//   initialData = {},
//   onSubmit,
//   mode,
...
//         {!isView && (
//           <form onSubmit={handleSubmit(onSubmit)}>
//             {fields.map(({ name, label, type, required, options, autocompleteProps }) => (
//               <label key={name} className="form-control mb-2">
//                 <span className="label-text">{label}</span>
//                 {/* ✨ Gérer le nouveau type 'autocomplete' 
//                 */}
//                 {type === 'autocomplete' ? (
//                   <AutocompleteInput
//                     placeholder={label}
//                     required={required}
//                     // Passer les props de l'AutocompleteInput
