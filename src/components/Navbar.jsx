...
// import { LogIn, LogOut, Home, Globe, ShoppingBasket, Menu } from 'lucide-react'
...
//             </Link>
//           ) : (
//             <button onClick={logout} className="btn btn-outline btn-sm gap-2 flex items-center">
...
//       {/* Menu Mobile Drawer */}
//       {isOpen && (
//         <div className="lg:hidden fixed inset-0 bg-base-200 z-50 p-4">
...
//               <>
//                 <li>
//                   <NavLink to="/countries" onClick={() => setIsOpen(false)}>
...
//           <div className="mt-4">
//             {!user ? (
//               <Link to="/login" onClick={() => setIsOpen(false)} className="btn btn-primary w-full">
//                 <LogIn className="w-4 h-4" /> {t('nav.login')}
//               </Link>
//             ) : (
//               <button onClick={() => { logout(); setIsOpen(false); }} className="btn btn-outline w-full">
...
//             </Link>
//           ) : (
//             // Changement ici pour le positionnement du dropdown
